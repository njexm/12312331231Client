...
namespace SorteClint.com.proem.sorte.dao
{
    class sorteDao
    {
        ...
        public string getIpName(string street)
        {
            ...
            string queryString = "select id, workname from ZC_WORKSTATION where WORKIP='" + street + "'";
            ...
            try
            {
                ...
                if (reader.Read())
                {
                    ConstantUtil.workName = reader.IsDBNull(1) ?  string.Empty : reader.GetString(1);
        ...
        public void AddtransitItem(orderSorte obj)
        {
            ...
            try
            {
                ...
                cmd.Parameters.Add(":SORTENUM", obj.sorteNum);
                cmd.Parameters.Add(":weight", obj.weight);
                cmd.Parameters.Add(":sorteId", ConstantUtil.sorteId);
                cmd.ExecuteNonQuery();
                tran.Commit();
            }
            catch (Exception ex)
